...
export function ConsoleSignature() {
  useEffect(() => {
    const heading =
      "color:#a6f500;font:700 14px monospace;padding:2px 0";
    const body = "color:#8c8c92;font:400 12px/1.6 monospace";
    const link = "color:#0b0b0c;background:#a6f500;font:700 12px monospace;padding:2px 6px";
    ...
    console.log(
      "%cGitHub → https://github.com/i-MMANTECH",
      body,
    );
  }, []);
